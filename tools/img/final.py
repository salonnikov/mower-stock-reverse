...
callout(731,624,120,150,"DIO  →  RPi GPIO24 (pin 18)")
callout(804,641,120,230,"CLK  →  RPi GPIO25 (pin 22)")
callout(1037,685,120,310,"GND  →  RPi GND (pin 6)")
# labels for the unused ones
d.text((640,560),"3V3 ✗",fill=RED,font=F(24)); d.text((905,610),"JTDO ✗",fill=RED,font=F(24)); d.text((980,628),"RES ✗",fill=RED,font=F(24))
# title
title="GD32F305 mainboard SWD  —  solder ONLY to the 3 green ones; don't touch the red ✗"

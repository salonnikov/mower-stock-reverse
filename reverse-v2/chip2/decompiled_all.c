...
/* ==== FUN_080001b4 @ 080001b4  size=8 ==== */

void FUN_080001b4(void)
...
/* ==== FUN_080001c6 @ 080001c6  size=2 ==== */

void FUN_080001c6(void)
...
/* ==== FUN_080001ca @ 080001ca  size=2 ==== */

void FUN_080001ca(void)
...
/* ==== FUN_080001ce @ 080001ce  size=2 ==== */

void FUN_080001ce(void)
...
{
  FUN_08001da8(&USART2_STAT0);
  FUN_08001a48(0x27);
  FUN_08000820(&DMA0_INTF,2);
  _DAT_e000e010 = 0;
  _DAT_e000e018 = 0;
  _DAT_e000e014 = 0;
  return;
...
/* ==== FUN_080002a4 @ 080002a4  size=2 ==== */

void FUN_080002a4(void)
...
/* ==== FUN_080002a8 @ 080002a8  size=2 ==== */

void FUN_080002a8(void)
...
/* ==== FUN_080002ac @ 080002ac  size=2 ==== */

void FUN_080002ac(void)
...
/* ==== FUN_080002b0 @ 080002b0  size=2 ==== */

void FUN_080002b0(void)
...
/* ==== thunk_FUN_0800078c @ 080002b4  size=4 ==== */

void thunk_FUN_0800078c(void)

{
  DAT_20000180 = DAT_20000180 + 1;
  if (DAT_20000064 == 0) {
    return;
  }
  DAT_20000064 = DAT_20000064 + -1;
  return;
}
...

{
  ...
  RCU_CFG1 = 0;
  uVar1 = RCU_CTL;
  RCU_CTL = uVar1 & 0xfef6ffff;
  RCU_INT = 0x9f0000;
  uVar1 = RCU_CTL;
  RCU_CTL = uVar1 & 0xfffbffff;
  uVar1 = RCU_CTL;
  RCU_CTL = uVar1 | 0x10000;
  iVar3 = 0xfffc;
  do {
    iVar4 = RCU_CTL;
    iVar4 = iVar4 << 0xe;
    ...
    if (((!bVar5 || iVar4 << 0xe < 0) || (uVar1 = RCU_CTL, iVar3 == 0)) || ((uVar1 & 0x20000) != 0))
    break;
    iVar4 = RCU_CTL;
    iVar3 = iVar3 + -4;
  } while (-1 < iVar4 << 0xe);
  ...
  uVar1 = RCU_APB1EN;
  RCU_APB1EN = uVar1 | 0x10000000;
  uVar1 = PMU_CTL;
  PMU_CTL = uVar1 | 0xc000;
  uVar2 = RCU_CFG0;
  RCU_CFG0 = uVar2;
  uVar2 = RCU_CFG0;
  RCU_CFG0 = uVar2;
  uVar1 = RCU_CFG0;
  RCU_CFG0 = uVar1 | 0x400;
  uVar1 = RCU_CFG0;
  RCU_CFG0 = uVar1 & 0xfffcffff;
  uVar1 = RCU_CFG0;
  RCU_CFG0 = uVar1 | 0x30000;
  uVar1 = RCU_CFG0;
  RCU_CFG0 = uVar1 & 0xb7c3ffff;
  uVar1 = RCU_CFG0;
  RCU_CFG0 = uVar1 | 0x8340000;
  uVar1 = RCU_CTL;
  RCU_CTL = uVar1 | 0x1000000;
  do {
    iVar3 = RCU_CTL;
    bVar5 = iVar3 << 6 < 0;
    if (!bVar5) {
  ...
  } while ((!bVar5) && (iVar3 = RCU_CTL, -1 < iVar3 << 6));
  uVar1 = PMU_CTL;
  PMU_CTL = uVar1 | 0x10000;
  do {
    iVar3 = PMU_CS;
    bVar5 = iVar3 << 0xf < 0;
    if (!bVar5) {
  ...
  } while ((!bVar5) && (iVar3 = PMU_CS, -1 < iVar3 << 0xf));
  uVar1 = PMU_CTL;
  PMU_CTL = uVar1 | 0x20000;
  do {
    iVar3 = PMU_CS;
    bVar5 = iVar3 << 0xe < 0;
    if (!bVar5) {
  ...
  } while ((!bVar5) && (iVar3 = PMU_CS, -1 < iVar3 << 0xe));
  uVar1 = RCU_CFG0;
  RCU_CFG0 = uVar1 & 0xfffffffc;
  uVar1 = RCU_CFG0;
  RCU_CFG0 = uVar1 | 2;
  while( true ) {
    iVar3 = RCU_CFG0;
...
/* ==== FUN_0800049c @ 0800049c  size=152 ==== */
...

{
  ...
  iVar1 = FUN_08001e64(&USART2_STAT0,0x40304);
  if (iVar1 == 0) {
    return;
  }
  FUN_08001d98(&USART2_STAT0);
  FUN_080007b4(&DMA0_INTF,2);
  if ((DAT_20000078 == -0x5b) && (DAT_20000079 - 1 < 0x15)) {
                    /* WARNING: Could not recover jumptable at 0x08001c90. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)((uint)*(byte *)(DAT_20000079 + 0x8001c93) * 2 + 0x8001c94))(&DAT_20000068,0x8001a31);
    return;
  }
  DAT_2000006c = &DAT_08001961;
  FUN_080008d0(&DMA0_INTF,2,&DAT_20000078,extraout_r3,unaff_r4,unaff_lr);
  FUN_080008f0(&DMA0_INTF,2,0x100);
  FUN_080007d8(&DMA0_INTF,2);
  return;
}
...

{
  ...
  FUN_08001bf8(0x712);
  FUN_08001da8(&USART2_STAT0);
  FUN_08001d2c(&USART2_STAT0,0x1c200);
  FUN_08001e88(&USART2_STAT0,0);
  FUN_08001ec0(&USART2_STAT0,0);
  FUN_08001ea4(&USART2_STAT0,0);
  FUN_08001eb4(&USART2_STAT0,8);
  FUN_08001e98(&USART2_STAT0,4);
  FUN_08001e24(&USART2_STAT0,0x40);
  FUN_08001e4c(&USART2_STAT0,0x304);
  FUN_08001a68(0x27,3,0);
  FUN_08001e30(&USART2_STAT0);
  local_2c = &USART2_DATA;
  uStack_28 = 0;
  ...
  FUN_08001bf8(0x500);
  FUN_08000820(&DMA0_INTF,2);
  FUN_0800085c(&DMA0_INTF,2,&local_2c);
  FUN_080007fc(&DMA0_INTF,2);
  FUN_080007d8(&DMA0_INTF,2);
  return;
}


/* ==== FUN_0800059c @ 0800059c  size=2 ==== */

void FUN_0800059c(void)
...

{
  ...
  FUN_08001bf8(0x605);
  FUN_08001bf8(0x600);
  FUN_080014d8(&GPIOB_CTL0,0x18,4,0x400);
  FUN_080014d8(&GPIOB_CTL0,4,4,0x800);
  FUN_080004d4();
  FUN_08001bf8(0x506);
  return;
}
...

{
  ...
  FUN_08000768(5);
  FUN_080008d0(&DMA0_INTF,2,&DAT_20000078);
  FUN_080008f0(&DMA0_INTF,2,0x100);
  FUN_080007d8(&DMA0_INTF,2);
  iVar1 = FUN_080014cc();
  do {
...

{
  ...
  if (param_2 != 0) {
    ...
    if ((uVar4 != 0) && (CRC_DATA = *(undefined4 *)(param_1 + uVar2 * 4), uVar4 != 1)) {
      param_1 = param_1 + uVar2 * 4;
      CRC_DATA = *(undefined4 *)(param_1 + 4);
      if (uVar4 != 2) {
        CRC_DATA = *(undefined4 *)(param_1 + 8);
      }
    }
  }
  uVar1 = CRC_DATA;
...
void FUN_080007b4(undefined *param_1,uint param_2)

{
  if ((param_1 == &DMA1_INTF) && (4 < param_2)) {
    do {
                    /* WARNING: Do nothing block with infinite loop */
    } while( true );
  }
  *(uint *)(param_1 + param_2 * 0x14 + 8) = *(uint *)(param_1 + param_2 * 0x14 + 8) & 0xfffffffe;
  return;
}
...
void FUN_080007d8(undefined *param_1,uint param_2)

{
  ...
  *(uint *)(param_1 + param_2 * 0x14 + 8) = *(uint *)(param_1 + param_2 * 0x14 + 8) | 1;
  return;
}
...
void FUN_080007fc(undefined *param_1,uint param_2)

{
  ...
  *(uint *)(param_1 + param_2 * 0x14 + 8) = *(uint *)(param_1 + param_2 * 0x14 + 8) & 0xffffffdf;
  return;
}
...
void FUN_08000820(undefined *param_1,uint param_2)

{
  ...
  *(uint *)(param_1 + param_2 * 0x14 + 8) = *(uint *)(param_1 + param_2 * 0x14 + 8) & 0xfffffffe;
  *(undefined4 *)(param_1 + param_2 * 0x14 + 8) = 0;
  *(undefined4 *)(param_1 + param_2 * 0x14 + 0xc) = 0;
  *(undefined4 *)(param_1 + param_2 * 0x14 + 0x10) = 0;
  *(undefined4 *)(param_1 + param_2 * 0x14 + 0x14) = 0;
...
void FUN_0800085c(undefined *param_1,uint param_2,undefined4 *param_3)

{
  ...
  *(undefined4 *)(param_1 + param_2 * 0x14 + 0x10) = *param_3;
  *(undefined4 *)(param_1 + param_2 * 0x14 + 0x14) = param_3[2];
  *(uint *)(param_1 + param_2 * 0x14 + 0xc) = (uint)*(ushort *)(param_3 + 4);
  *(uint *)(param_1 + param_2 * 0x14 + 8) =
       param_3[3] | param_3[1] | *(uint *)(param_1 + param_2 * 0x14 + 8) & 0xffffc0ff | param_3[5];
  uVar1 = *(uint *)(param_1 + param_2 * 0x14 + 8) & 0xffffffbf;
  if (*(char *)(param_3 + 6) == '\x01') {
    uVar1 = uVar1 + 0x40;
  }
  *(uint *)(param_1 + param_2 * 0x14 + 8) = uVar1;
  uVar1 = *(uint *)(param_1 + param_2 * 0x14 + 8) & 0xffffff7f;
  if (*(char *)((int)param_3 + 0x19) == '\x01') {
    uVar1 = uVar1 + 0x80;
  }
  *(uint *)(param_1 + param_2 * 0x14 + 8) = uVar1;
  uVar1 = *(uint *)(param_1 + param_2 * 0x14 + 8) & 0xffffffef;
...
void FUN_080008d0(undefined *param_1,uint param_2,undefined4 param_3)
...
void FUN_080008f0(undefined *param_1,uint param_2,ushort param_3)
...
LAB_08000afa:
      ...
      if (bVar5 || (uVar2 & 1) == 0) goto LAB_08000afa;
      uVar2 = FMC_STAT0;
      bVar5 = (uVar2 & 1) == 0;
      uVar2 = 0;
      if (!bVar5) {
...
LAB_08000cb4:
        ...
        if (bVar5 || (uVar2 & 1) == 0) goto LAB_08000cb4;
        uVar2 = FMC_STAT0;
        bVar5 = (uVar2 & 1) == 0;
        uVar2 = 0;
        if (!bVar5) {
...
LAB_08000da6:
        ...
        if (bVar5 || (uVar2 & 1) == 0) goto LAB_08000da6;
        uVar2 = FMC_STAT1;
        bVar5 = (uVar2 & 1) == 0;
        uVar2 = 0;
        if (!bVar5) {
  ...
  while( true ) {
    ...
    if (bVar5 || (uVar2 & 1) == 0) goto LAB_08000e8c;
    uVar2 = FMC_STAT0;
    bVar5 = (uVar2 & 1) == 0;
    uVar2 = 0;
    if (!bVar5) {
...
LAB_08000ebe:
  ...
  while( true ) {
    ...
    if (bVar5 || (uVar2 & 1) == 0) goto LAB_08000eac;
    uVar2 = FMC_STAT1;
    bVar5 = (uVar2 & 1) == 0;
    uVar2 = 0;
    if (!bVar5) {
...
LAB_08000eda:
  ...
  while( true ) {
    ...
    if (bVar5 || (uVar2 & 1) == 0) goto LAB_08000e9c;
    uVar2 = FMC_STAT0;
    bVar5 = (uVar2 & 1) == 0;
    uVar2 = 0;
    if (!bVar5) {
...
LAB_080010fc:
      ...
      if (bVar5 || (uVar2 & 1) == 0) goto LAB_080010fc;
      uVar2 = FMC_STAT0;
      bVar5 = (uVar2 & 1) == 0;
      uVar2 = 0;
      if (!bVar5) {
...
LAB_080012b2:
        ...
        if (bVar5 || (uVar2 & 1) == 0) goto LAB_080012b2;
        uVar2 = FMC_STAT0;
        bVar5 = (uVar2 & 1) == 0;
        uVar2 = 0;
        if (!bVar5) {
...
LAB_0800139a:
        ...
        if (bVar5 || (uVar2 & 1) == 0) goto LAB_0800139a;
        uVar2 = FMC_STAT1;
        bVar5 = (uVar2 & 1) == 0;
        uVar2 = 0;
        if (!bVar5) {
  ...
  while( true ) {
    ...
    if (bVar5 || (uVar2 & 1) == 0) goto LAB_08001470;
    uVar2 = FMC_STAT0;
    bVar5 = (uVar2 & 1) == 0;
    uVar2 = 0;
    if (!bVar5) {
...
LAB_080014a2:
  ...
  while( true ) {
    ...
    if (bVar5 || (uVar2 & 1) == 0) goto LAB_08001490;
    uVar2 = FMC_STAT1;
    bVar5 = (uVar2 & 1) == 0;
    uVar2 = 0;
    if (!bVar5) {
...
LAB_080014be:
  ...
  while( true ) {
    ...
    if (bVar5 || (uVar2 & 1) == 0) goto LAB_08001480;
    uVar2 = FMC_STAT0;
    bVar5 = (uVar2 & 1) == 0;
    uVar2 = 0;
    if (!bVar5) {
...

{
  ...
  DAT_20000178 = &LAB_080017cc;
  do {
    iVar1 = FUN_08001e3c(&USART2_STAT0,7);
  } while (iVar1 == 0);
  FUN_08001da0(&USART2_STAT0,0x62);
  do {
    iVar1 = FUN_08001e3c(&USART2_STAT0,7);
  } while (iVar1 == 0);
  FUN_08001da0(&USART2_STAT0,0x74);
  do {
    iVar1 = FUN_08001e3c(&USART2_STAT0,7);
  } while (iVar1 == 0);
  FUN_08001da0(&USART2_STAT0,0x6c);
  FUN_08000768(2);
  return;
}
...
{
  if (DAT_2000006c == (code *)0x0) {
    return;
  }
  (*DAT_2000006c)();
  DAT_2000006c = (code *)0x0;
  return;
}
...

{
  ...
  uVar3 = (DAT_2000007a & 0xff) << 8 | (uint)(DAT_2000007a >> 8);
  FUN_08000ee8();
  if (uVar3 != 0) {
    iVar2 = 0x10;
    do {
      FUN_08000f38(DAT_20000070 + DAT_2000017c + iVar2 + -0x10,
                   *(undefined4 *)((int)&DAT_2000006c + iVar2));
      uVar1 = iVar2 - 0xc;
      iVar2 = iVar2 + 4;
    } while (uVar1 < uVar3);
  }
  FUN_08000910();
  DAT_2000017c = DAT_2000017c + uVar3;
  DAT_20000178 = &DAT_08001ef2;
  do {
    iVar2 = FUN_08001e3c(&USART2_STAT0,7);
  } while (iVar2 == 0);
  FUN_08001da0(&USART2_STAT0,0x6f);
  do {
    iVar2 = FUN_08001e3c(&USART2_STAT0,7);
  } while (iVar2 == 0);
  FUN_08001da0(&USART2_STAT0,0x6b);
  do {
    iVar2 = FUN_08001e3c(&USART2_STAT0,7);
  } while (iVar2 == 0);
  FUN_08001da0(&USART2_STAT0,0x21);
  return;
}
...

{
    ...
    if ((uVar1 & 0x700) == 0x600) {
      ...
      if ((uVar1 & 0x700) == 0x500) {
        ...
        if ((uVar1 & 0x700) == 0x400) {
          ...
          uVar1 = DAT_e000ed0c;
          if ((uVar1 & 0x700) == 0x300) {
            iVar2 = 0;
          }
          else {
            DAT_e000ed0c = 0x5fa0500;
            iVar2 = 2;
          }
        }
      }
  ...
  *(char *)((param_1 | 0xe000e100) + 0x300) =
       (char)((0xfU >> (4U - iVar2 & 0xff) & param_3 | param_2 << iVar2) << 4);
  *(int *)(&NVIC_ISER + (param_1 >> 3 & 0x1c)) = 1 << (param_1 & 0x1f);
  return;
}
...
{
  DAT_e000ed0c = param_1 | 0x5fa0000;
  return;
}
...

{
  ...
  if ((uVar6 & 0xc) == 8) {
    ...
    uVar5 = RCU_CFG0;
    uVar2 = RCU_CFG0;
    uVar5 = (uVar2 >> 0x19 & 0x20) + ((uVar4 & 0x3fffff) >> 0x12) + (uVar5 >> 0x17 & 0x10);
    uVar4 = uVar5;
    if (uVar5 != 0x3f) {
      uVar4 = uVar5 + 1;
    }
  ...
  uVar2 = RCU_CFG0;
  if (param_1 < 4) {
    uVar6 = uVar4 >> (&DAT_08001be8)[(uVar6 & 0xff) >> 4];
    switch(param_1) {
    case 1:
      return uVar6;
    case 2:
      return uVar6 >> (&DAT_08001eea)[(uVar5 & 0x7ff) >> 8];
    case 3:
      uVar4 = uVar6 >> (&DAT_08001eea)[(uVar2 & 0x3fff) >> 0xb];
    }
    return uVar4;
  }
  return 0;
...
{
  *(uint *)((int)&RCU_CTL + (param_1 >> 6)) =
       1 << (param_1 & 0x1f) | *(uint *)((int)&RCU_CTL + (param_1 >> 6));
  return;
}
...
void FUN_08001d2c(undefined *param_1,uint param_2)

{
  ...
  iVar1 = 0;
  if ((int)param_1 < 0x40004c00) {
    if ((param_1 != &USART1_STAT0) && (param_1 != &USART2_STAT0)) goto LAB_08001d88;
LAB_08001d82:
    uVar2 = 2;
  }
  else {
    if ((param_1 == &UART3_STAT0) || (param_1 == &UART4_STAT0)) goto LAB_08001d82;
    if (param_1 != &USART0_STAT0) goto LAB_08001d88;
    uVar2 = 3;
  }
...
void FUN_08001da8(undefined *param_1)

{
  uint uVar1;
  
  if ((int)param_1 < 0x40004c00) {
    if (param_1 == &USART1_STAT0) {
      uVar1 = 0x411;
    }
    else {
      if (param_1 != &USART2_STAT0) {
        return;
      }
      uVar1 = 0x412;
    }
  }
  else if (param_1 == &UART3_STAT0) {
    uVar1 = 0x413;
  }
  else if (param_1 == &UART4_STAT0) {
    uVar1 = 0x414;
  }
  else {
    if (param_1 != &USART0_STAT0) {
      return;
    }
    uVar1 = 0x30e;
  }
  FUN_08001c38(uVar1);
  *(uint *)((int)&RCU_CTL + (uVar1 >> 6)) =
       *(uint *)((int)&RCU_CTL + (uVar1 >> 6)) & ~(1 << (uVar1 & 0x1f));
  return;
}
...

{
  ...
  puVar2 = (undefined4 *)DAT_e000ed08;
  bVar1 = (bool)isCurrentModePrivileged();
  if (bVar1) {
...
/* ==== FUN_0801094c @ 0801094c  size=18 ==== */

undefined4 FUN_0801094c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  FUN_0801093a(param_1,param_3,param_2);
  return param_1;
}
...

{
  ...
  for (puVar3 = &DAT_0801cc00; puVar3 < &DAT_0801cc40; puVar3 = puVar3 + 4) {
    (*(code *)puVar3[3])(*puVar3,puVar3[1],puVar3[2]);
  }
  uVar1 = FUN_08010138();
  if ((int)extraout_r2 < 0x20) {
    iVar2 = 0 >> (extraout_r2 & 0xff);
    uVar1 = uVar1 >> (extraout_r2 & 0xff) | 0 << (0x20 - extraout_r2 & 0xff);
  }
  else {
    uVar1 = 0 >> (extraout_r2 - 0x20 & 0xff);
...
/* ==== FUN_0801179a @ 0801179a  size=92 ==== */

uint FUN_0801179a(int param_1,uint param_2,int param_3,int param_4)
...
LAB_08017c22:
  ...
  *(int *)(&NVIC_ISER + (param_1 >> 5) * 4) = 1 << (param_1 & 0x1f);
  return;
}
...
/* ==== FUN_0801899c @ 0801899c  size=70 ==== */

void FUN_0801899c(void)

{
  ...
  while (*(int *)(iVar2 + 4) != 0) {
    ...
    if (*piVar1 == 0) {
      ...
      FUN_0801c818();
      FUN_0801b458();
      iVar3 = *(int *)(piVar1[3] + 0xc);
      FUN_0801b3ce(iVar3 + 4);
...

{
  ...
  puVar2 = DAT_0801aff8;
  puVar1 = DAT_0801aff4;
  if ((((param_1 == DAT_0801aff4) || (param_1 == (uint *)&TIMER1_CTL0)) || (param_1 == DAT_0801affc)
...

{
  ...
  if ((0xf < uVar2) && ((byte)(&DAT_e000e3f0)[uVar2] < *_DAT_0801b624)) {
